...
header('Refresh: 10; URL=http://tote.hostoi.com/');
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>Thanks for using TOTE!</h1>
                        <h3>Check your your email - that's where we sent the details of your trip.</h3>
                        <h4>In a few second you will be redirected to the home page. If for some reason <br>that does not happen, please use the button below.</h4>
 ...
 <!-- Footer -->
    <footer>
        <div class="container">
            <div class="row">
                <p>Feel free to <a href=mailto:mkotov13@simons-rock.edu>email me</a> with feedback and suggestions</p>
                <p class="copyright text-muted small">&copy; 2015 Tote Inc.</p>
            </div>
        </div>
    </footer>
